...
function setup() {
	...
	roofObject=new roof(500,0,230,20);
	bob1 = new bob(350,475,150)
	ground = new roof(500, 600, width, 10)


	off1= new bounce(-40,435,70,1000)
	off2= new bounce(1050,435,70,1000)
	//off3= new bounce(1050,435,400,70)
	...
	block21 = new block(670, 435, 70, 70)
...
function keyPressed() {
	if(keyCode === LEFT_ARROW) {
		Matter.Body.applyForce(bob1.body, bob1.body.position, {x:-400, y:445})
	}	
